...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('clientes_obra', (
            ...
            ('chapa', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ...
            ('bloque', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ...
            ('fieltro', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('porton', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('canaletas', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ...
        db.create_table('clientes_costo', (
            ...
            ('unidad', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sistema.Unidad'], null=True, blank=True)),
            ('valor_unitario', self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=5, decimal_places=2)),
            ('total', self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=5, decimal_places=2)),
    ...
    models = {
        ...
        'clientes.costo': {
            ...
            'total': ('django.db.models.fields.DecimalField', [], {'default': '0.0', 'max_digits': '5', 'decimal_places': '2'}),
            'unidad': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['sistema.Unidad']", 'null': 'True', 'blank': 'True'}),
        ...
        'clientes.obra': {
            ...
            'bloque': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'canaletas': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'chapa': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'conjunto_obra': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['clientes.ConjuntoObra']"}),
            'cubierta': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['sistema.TipoEstructura1']", 'null': 'True', 'blank': 'True'}),
            'fieltro': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'porton': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
